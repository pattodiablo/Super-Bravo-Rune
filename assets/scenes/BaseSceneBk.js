...
class BaseScene extends Phaser.Scene {
	...
	create(){
		...
		if(this.tilespriteBG !== undefined){
			...
			}else if(this.scene.key=="NewLevel0" || this.scene.key=="NewLevel0A" || this.scene.key=="NewLevel0B" || this.scene.key=="NewLevel0C" || this.scene.key=="NewLevel0D" || this.scene.key=="NewLevel1B"  || this.scene.key=="NewLevel1C"  || this.scene.key=="NewLevel1D"  || this.scene.key=="NewLevel1E"  || this.scene.key=="NewLevel1F"  || this.scene.key=="NewLevel1X"  || this.scene.key=="NewLevel1Y"){ 
